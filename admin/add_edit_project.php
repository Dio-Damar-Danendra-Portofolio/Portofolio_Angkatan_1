<?php 
    ...
    $row_edit = mysqli_fetch_assoc($querquery_project);
    ...
    if (isset($_POST["simpan"])) {
        ...
        $insert = mysqli_query($conn, "INSERT INTO project (nama, kategori, foto) VALUES ('$nama', '$kategori', '$namaFile')");
    ...
    if (isset($_GET['idEdit'])) {
      $idEdit = $_GET['idEdit'];
      $queryEdit = mysqli_query($conn, "SELECT foto FROM project WHERE id = $idEdit;");
    ...
    if (isset($_POST['sunting'])) {
      if (isset($_GET['idEdit'])) {
        ...
        if ($foto['error'] == 0) {
          $namaBerkas = uniqid() . "_" .basename($foto['name']);
          $lokasiFile = "../assets/uploads/" . $namaBerkas;
        ...
        $queryUpdate = mysqli_query($conn, "UPDATE project SET $fillQUpdate nama='$nama', kategori='$kategori' WHERE id = $idEdit;");
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="row-mb-3">
                    <div class="col-sm-2">
                        <label class="form-label" for="nama">Nama Project: </label>
                    </div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama project Anda!" required value="<?= isset($_GET['idEdit']) || isset($_GET['sidebar']) ? $row_edit['nama_project'] : ''?>">
                    </div>
                </div>
                <div class="row-mb-3">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="kategori" id="kategori" placeholder="Masukkan kategori project Anda!" value="<?= isset($_GET['idEdit']) || isset($_GET['sidebar']) ? $row_edit['kategori'] : ''?>">
                    </div>
                </div>
                <div class="row-mb-3">
                    <div class="col-sm-2">
                        <label class="form-label" for="foto" >Kategori: </label>
                    </div>
                    <div class="col-sm-10">
